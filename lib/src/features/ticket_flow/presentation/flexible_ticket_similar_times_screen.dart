...
import '../domain/models/train_times.dart';
import 'package:hooks_riverpod/hooks_riverpod.dart';

class FlexibleTicketSimilarTimesScreen extends HookConsumerWidget {
  const FlexibleTicketSimilarTimesScreen({
    super.key,
    required this.possibleTrainTimes,
  });

  final List<TrainTime>? possibleTrainTimes;
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        Text(
                          possibleTrainTimes![index].departureTime,
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Text(
                          possibleTrainTimes![index].arrivalTime,
                          style: const TextStyle(color: Colors.white, fontSize: 39),
                        ),
                      ],
                    ),
